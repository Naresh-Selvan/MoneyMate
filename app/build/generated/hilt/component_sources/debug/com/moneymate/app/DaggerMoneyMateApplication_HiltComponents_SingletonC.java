...
public final class DaggerMoneyMateApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends MoneyMateApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.paymentRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<PaymentRepository>(singletonCImpl, 7));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 7: // com.moneymate.app.data.repository.PaymentRepository 
