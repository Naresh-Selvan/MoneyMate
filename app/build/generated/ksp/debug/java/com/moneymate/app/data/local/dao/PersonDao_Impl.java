...
public final class PersonDao_Impl implements PersonDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateAmountAndDate;

  private final SharedSQLiteStatement __preparedStmtOfUpdateAmountAndDateResetInterest;
  ...
  private final SharedSQLiteStatement __preparedStmtOfUpdateInterestFields;
  ...
  public PersonDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__preparedStmtOfUpdateAmountAndDate = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE persons SET amountGiven = ?, dateGiven = ? WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateAmountAndDateResetInterest = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "\n"
    ...
    this.__preparedStmtOfDeleteZeroCloneByNameAndFile = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM persons WHERE name = ? AND fileId = ? AND amountGiven = 0.0 AND isCompleted = 0 AND isPendingNewLoan = 1";
        return _query;
      }
    };
    this.__preparedStmtOfRemoveDuplicatePendingClones = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "\n"
    ...
    this.__preparedStmtOfUpdateInterestFields = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "\n"
  ...
  @Override
  public Object updateAmountAndDate(final String id, final double amount, final long dateGiven,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateAmountAndDate.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfUpdateAmountAndDate.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Object updateAmountAndDateResetInterest(final String id, final double amount,
      final long dateGiven, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateAmountAndDateResetInterest.acquire();
        int _argIndex = 1;
        _stmt.bindDouble(_argIndex, amount);
        _argIndex = 2;
        _stmt.bindLong(_argIndex, dateGiven);
        ...
        try {
          ...
          __preparedStmtOfUpdateAmountAndDateResetInterest.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Object deleteZeroCloneByNameAndFile(final String name, final String fileId,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteZeroCloneByNameAndFile.acquire();
        int _argIndex = 1;
        _stmt.bindString(_argIndex, name);
        _argIndex = 2;
        _stmt.bindString(_argIndex, fileId);
        try {
          ...
          __preparedStmtOfDeleteZeroCloneByNameAndFile.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Object removeDuplicatePendingClones(final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfRemoveDuplicatePendingClones.acquire();
        try {
          __db.beginTransaction();
          try {
            _stmt.executeUpdateDelete();
          ...
          __preparedStmtOfRemoveDuplicatePendingClones.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  public Object updateInterestFields(final String id, final double interestRate,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfUpdateInterestFields.acquire();
        int _argIndex = 1;
        _stmt.bindDouble(_argIndex, interestRate);
        _argIndex = 2;
        _stmt.bindString(_argIndex, interestType);
        ...
        try {
          ...
          __preparedStmtOfUpdateInterestFields.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  public Flow<List<Person>> getDeletedPersons() {
    final String _sql = "SELECT * FROM persons WHERE isDeleted = 1 AND isCompleted = 0 AND isPendingNewLoan = 0 ORDER BY deletedAt DESC";
  ...
  public Object getTotalGivenInFile(final String fileId,
    ...
    final String _sql = "SELECT SUM(amountGiven) FROM persons WHERE fileId = ? AND isDeleted = 0 AND isCompleted = 0";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, fileId);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  public Object getTotalGivenCashInFile(final String fileId,
      final Continuation<? super Double> $completion) {
    final String _sql = "SELECT SUM(amountGiven) FROM persons WHERE fileId = ? AND isDeleted = 0 AND isCompleted = 0 AND mode = 'CASH'";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, fileId);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  public Object getTotalGivenUpiInFile(final String fileId,
      final Continuation<? super Double> $completion) {
    final String _sql = "SELECT SUM(amountGiven) FROM persons WHERE fileId = ? AND isDeleted = 0 AND isCompleted = 0 AND mode = 'UPI'";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, fileId);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
  ...
  @Override
  public Object countPendingClones(final String name, final String fileId,
      final Continuation<? super Integer> $completion) {
    final String _sql = "\n"
  ...
  @Override
  public Object countZeroActiveCards(final String name, final String fileId,
      final Continuation<? super Integer> $completion) {
    final String _sql = "\n"
            + "        SELECT COUNT(*) FROM persons\n"
            + "        WHERE name = ?\n"
  ...
  @Override
  public Flow<List<Person>> getLoanHistoryByPersonId(final String personId) {
    final String _sql = "\n"
            + "        SELECT * FROM persons\n"
            + "        WHERE fileId = (SELECT fileId FROM persons WHERE id = ?)\n"
            + "          AND LOWER(name) = LOWER((SELECT name FROM persons WHERE id = ?))\n"
            + "          AND isDeleted = 0\n"
            + "          AND isPendingNewLoan = 0\n"
  ...
  @Override
  public Object getExpiredDeletedPersons(final long cutoff,
      final Continuation<? super List<Person>> $completion) {
    final String _sql = "SELECT * FROM persons WHERE isDeleted = 1 AND deletedAt < ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
  ...
  @Override
  public Flow<List<Person>> getAllDeletedPersons() {
  ...
  @Override
  public Flow<List<Person>> getAllPersonsIncludingDeleted() {
