...
public final class AppModule_ProvideDefaultPersonDaoFactory implements Factory<DefaultPersonDao> {
  ...
  public static AppModule_ProvideDefaultPersonDaoFactory create(
      javax.inject.Provider<AppDatabase> dbProvider) {
    return new AppModule_ProvideDefaultPersonDaoFactory(Providers.asDaggerProvider(dbProvider));
  }
