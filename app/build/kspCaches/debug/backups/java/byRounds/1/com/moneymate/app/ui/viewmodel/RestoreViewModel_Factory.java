...
public final class RestoreViewModel_Factory implements Factory<RestoreViewModel> {
  ...
  public static RestoreViewModel_Factory create(
    ...
    return new RestoreViewModel_Factory(Providers.asDaggerProvider(loanFileRepositoryProvider), Providers.asDaggerProvider(personRepositoryProvider), Providers.asDaggerProvider(paymentRepositoryProvider), Providers.asDaggerProvider(expenseRepositoryProvider), Providers.asDaggerProvider(investmentRepositoryProvider), Providers.asDaggerProvider(pathsProvider));
  }
  ...
  public static RestoreViewModel_Factory create(
      ...
      Provider<InvestmentRepository> investmentRepositoryProvider,
      Provider<FirestorePathProvider> pathsProvider) {
    return new RestoreViewModel_Factory(loanFileRepositoryProvider, personRepositoryProvider, paymentRepositoryProvider, expenseRepositoryProvider, investmentRepositoryProvider, pathsProvider);
  }
  ...
  public static RestoreViewModel newInstance(LoanFileRepository loanFileRepository,
    ...
    return new RestoreViewModel(loanFileRepository, personRepository, paymentRepository, expenseRepository, investmentRepository, paths);
  }
}
