...
public final class DaggerMoneyMateApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends MoneyMateApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.loanFileRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<LoanFileRepository>(singletonCImpl, 6));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 6: // com.moneymate.app.data.repository.LoanFileRepository 
